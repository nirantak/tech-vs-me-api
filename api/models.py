...
class Posts(models.Model):
    ...
    url = models.URLField('url', unique=True, error_messages={
...
class Authors(models.Model):
    username = models.CharField('username', max_length=100, unique=True, error_messages={
                                'unique': 'This username already exists!'})
    name = models.CharField('name', max_length=100)
    social = models.URLField('social', max_length=255, unique=True, error_messages={
                             'unique': 'This link already exists!'})
